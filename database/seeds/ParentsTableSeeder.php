...
{
    /**
     * Demo parent for guard "parent" (/login/parent).
     *
     * Email: parent@school.local · Password: password123
     *
     * @return void
     */
    public function run()
    {
        DB::table('my__parents')->delete();
            ...
            $my_parents->email = 'parent@school.local';
            $my_parents->password = Hash::make('password123');
