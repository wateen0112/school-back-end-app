        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post"  action="{{ route('Students.store') }}" autocomplete="off" enctype="multipart/form-data">
                    @csrf
                    <h6 class="text-title-lg text-primary mb-3">{{trans('Students_trans.personal_information')}}</h6>
                        <div class="row">
                            <div class="col-md-6">
                    ...
                    <h6 class="text-title-lg text-primary mb-3">{{trans('Students_trans.Student_information')}}</h6>
                    <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                    ...
                    <button class="btn btn-success fade-in" type="submit">{{trans('Students_trans.submit')}}</button>
                </form>
